...
And then there is external pressure. Governments and regulators do not like systems they cannot access, so companies are often pushed to design around that. What gets marketed as "secure" can end up being a compromise behind the scenes.
