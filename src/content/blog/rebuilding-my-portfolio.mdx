...
When building a personal website, it’s easy to overdo things. You start with a simple idea, add animations and complex layouts, and before long, you’ve built something that loads slowly and is hard to maintain.
...
Alternatively, I could have chosen a better and more lightweight option like [Astro](https://astro.build). Infact, my [old website](https://urdadx.vercel.app) was even built using Astro. But after building [Padyna](https://padyna.com) with TanStack Start, it felt like home. I really liked TanStack Start’s mental model—file-based routing, tight integration with TanStack Query, and how everything fits together.
