  ...
  head: ({ loaderData, params }) => ({
    meta: [
      ...
      },
      {
        ...
        content:
          loaderData?.post.ogImage?.endsWith(".jpg") ||
          loaderData?.post.ogImage?.endsWith(".jpeg")
            ? "image/jpeg"
            : "image/png",
      },
      {
...
function BlogPost() {
  ...
  const markdownComponents: MDXComponents = {
    ...
    code: ({
      ...
      return (
        <pre className="bg-muted/50 p-3 rounded overflow-x-auto mb-4 max-w-2xl mx-auto">
    ...
    blockquote: ({ children }) => (
      <blockquote
        className="border-l-3 border-muted-foreground/30 pl-6 italic mb-6 max-w-2xl mx-auto"
        style={{
